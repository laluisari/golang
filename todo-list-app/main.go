...
func FlyURL() string {
	return "https://laluisari-final-project-be2957586.fly.dev" // TODO: replace this
}

func main() {
	//TODO: hapus jika sudah di deploy di fly.io
	os.Setenv("DATABASE_URL", "postgres://postgres:Laluisari09@localhost:5432/last")
	//flyctl secrets set DATABASE_URL=postgres://postgres:CgtViUx4p1xuQ3m@laluisari-final-project-be2957586-db.internal:5432
