...
var _ = Describe("RecordInvoice", func() {
	...
	Describe("Finance", invoice.MarketingTestCase)
	Describe("Warehouse", invoice.MarketingTestCase)
})
...
var _ = Describe("RecapDataInvoice", func() {
	...
	When("all invoice data with difference date and difference departemen", func() {
