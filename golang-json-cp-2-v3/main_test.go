		...
		It("should return with EndBalance 0, and total loan not more than total balance", func() {
			Expect(main.LoanReport(
				...
				main.LoanRecord{
					...
					StartBalance: 250000,
					EndBalance:   0,
					Borrowers: []main.Borrower{{"1", "Employee A", 100000},
						{"2", "Employee B", 50000},
						{"3", "Employee C", 50000},
						{"4", "Employee D", 50000},
					},
...
var _ = Describe("RecordJSON", func() {
	...
	When("Record data is normal", func() {
		It("should record data and not return error", func() {
			...
			Expect(err).To(BeNil())
			Expect(AssertRecord()).To(Equal(`{"month_date":"January 2021","start_balance":500000,"end_balance":50000,"borrowers":[{"id":"1","name":"Employee A","total_loan":150000},{"id":"2","name":"Employee B","total_loan":150000},{"id":"3","name":"Employee C","total_loan":150000}]}`))
		})
	})
